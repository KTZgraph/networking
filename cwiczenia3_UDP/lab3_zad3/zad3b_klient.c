/*
[KLIENT TCP] [Zadanie 3b)] 

Przesyłanie bloków 30000-bajtowych za pomocą protokołu 
TCP w jednej sesji z pomiarem czasu. Program powinien działać 
wg schematu pomiar czasu, socket, connect, 100 razy send i 
recv, close, pomiar czasu, podanie czasu podzielonego przez 100.
*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
